...
export class CommonService {
  ...
  //   overrrideFindOptions: FindManyOptions<T> = {},
  //   path: string,
  // ) {
  //   console.log(dto.page);
  //   if (dto.page) {
  //     console.log('pagePaginate');
  //     return this.pagePaginate(dto, repository, overrrideFindOptions);
  //   } else {
  //     return this.cursorPaginate(dto, repository, overrrideFindOptions, path);
  //   }
  // }
  ...
  private parseWhereFilter<T extends BaseModel>(
    ...
    if (split.length === 2) {
       ...
       * where는 버려도 되고 두변째 값은 필터할 키값이 되고
